...
import { Marker, Popup, TileLayer, Map as LeafletMap, GeoJson } from 'react-leaflet'
...
export default class BrowsochronesExample extends Component {
  ...
  moveOrigin = (e) => {
    ...
    this.setState({...this.state, origin, isochrone: null, transitive: null, inVehicleTravelTime: null, travelTime: null, waitTime: null})
    ...
    .then(async (buff) => {
      ...
      this.setState({...this.state, isochrone, key: uuid.v4(), origin, transitive: null, inVehicleTravelTime: null, travelTime: null, waitTime: null})
    })
  }
  ...
  render () {
    let { transitive, isochrone, key, origin, destination, travelTime, waitTime, inVehicleTravelTime, loaded } = this.state
